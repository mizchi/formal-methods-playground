...
| [`fstar/`](fstar/) | F* | refinement types + SMT for verified implementation cores |
...
| [`p/`](p/) | P language | actor-model state machines with built-in checker |
...
| F* | `fstar/CheckoutForm.fst` | checkout-form constructors carry refinement contracts; invalid witnesses proved false with lemmas |
...
| P | `p/PingPong/` | two-actor ping-pong + safety monitor; 1000 schedules, 0 bugs |
